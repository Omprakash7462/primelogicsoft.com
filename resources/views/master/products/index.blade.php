                                        ...
                                        <tbody>
                                            @foreach ($products as $key => $product)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('master.products.edit', $product->id) }}" class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i></a>
                                                        <a href="{{ route('master.products.delete', $product->id) }}" class="btn btn-danger btn-sm confirm-delete"><i class="bi bi-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
