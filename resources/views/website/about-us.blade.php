@section('title', 'About Prime Logic Soft | Web, Mobile & Digital Solutions Company')
@section('meta_title', 'About Prime Logic Soft | Web, Mobile & Digital Solutions Company')
@section('meta_description', 'Learn about Prime Logic Soft, a technology company providing website development, mobile app development, SaaS solutions, and digital marketing services to help businesses grow with modern digital solutions.')
@section('meta_keywords', 'Prime Logic Soft, web development company, mobile app development, SaaS development services, custom website development, digital marketing solutions, IT company')
    ...
    <section class="section-area section-sp3 team-wraper">
        <div class="container-fluid">
            <div class="heading-bx text-center">
                <h6 class="title-ext text-secondary">Our Teams</h6>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="team-member">
                        <div class="team-media">
                            <img src="{{ asset('assets/images/team/member.jpg') }}" alt="">
                        </div>
                        <div class="team-info">
                            <div class="team-info-comntent">
                                <h4 class="title">Rajkunti Sahu</h4>
                                <span class="text-secondary">CEO</span>
                            </div>                            
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="team-member active">
                        ...
                        <div class="team-info">
                            <div class="team-info-comntent">
                                <h4 class="title">Omprakash Kumar</h4>
                                <span class="text-secondary">It Head</span>
                            </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="team-member">
                        ...
                        <div class="team-info">
                            <div class="team-info-comntent">
                                <h4 class="title">Barun</h4>
                                <span class="text-secondary">Marketing Head</span>
                            </div>                            
                        </div>
                    </div>
                </div>
        ...
        <img class="pt-img5 animate-wave" src="{{ asset('assets/images/shap/circle-dots.png') }}" alt="">
    </section>
