                ...
                <div class="col-md-12 col-lg-7 col-xl-8 mb-30 mb-md-50">
                    ...
                    <div class="blog-card blog-single">
                        <div class="post-media">
                            <img src="{{ asset('storage/services/'.$service->image) }}" class="img-thumbnail" alt="{{ $service->name }}">
                        </div>
                        <div class="info-bx">
                            <ul class="post-meta">
                                <li class="author"><i class="far fa-user"></i> Admin</li>
                                <li class="date"><i class="far fa-calendar-alt"></i> {{ date('d M Y', strtotime($service->created_at)) }}</li>
                            </ul>
                ...
                <div class="col-md-12 col-lg-5 col-xl-4 mb-30">
                    <aside class="side-bar sticky-top aside-bx">
                        <div class="widget widget_search">
                            <form method="GET" role="search" action="{{ route('services.details', ['slug'=> $service->slug]) }}" class="searchform">
                                ...
                                @foreach ($services as $service)
                                    <div class="widget-post clearfix">
                                        <div class="ttr-post-media"> 
                                            <img src="{{ asset('storage/services/'.$service->image) }}" width="200" height="143" alt="{{ $service->name }}"> 
                                        </div>
                                        <div class="ttr-post-info">
                                            <div class="ttr-post-header">
                                                <h6 class="post-title">
                                                    <a href="{{ route('services.details', ['slug'=> $service->slug]) }}">{{ $service->name }}</a>
                                                </h6>
                                            </div>
                                            <ul class="post-meta">
                                                <li class="date"><i class="far fa-calendar-alt"></i> {{ date('d M Y', strtotime($service->created_at)) }}</li>
